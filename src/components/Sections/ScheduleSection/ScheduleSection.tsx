				...
				<ul className='schedule__list'>
					...
					<li className='schedule__item'>
						<div className='second__border'>
							...
							<p className='schedule__description mb-10'>9998 Front Ave. Labrador City, LB A2V 6N5</p>
						...
						<div className='second__border'>
							...
							<div>
								<div>
									...
									<Link className='schedule__description mb-10' to='tel:+1(605) 234-3233'>
										+1 (605) 234-3233
									</Link>
								</div>
								<div>
									<p className='schedule__days'>Email:</p>
									<Link className='schedule__description' to='mailto:restaurant@gmail.com'>
