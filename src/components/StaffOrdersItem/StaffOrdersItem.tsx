	...
	return (
		<li className='order__item order__item__flex'>
			<div onClick={handleToggle} className='order__left__wrapper'>
				<MdKeyboardArrowDown className={`staff__order__icon ${showAdditional ? 'order__icon--transform' : ''}`} />
				<div className='order__item__wrapper order__item__wrapper--margin'>
					<div className='order__number'>
						...
						<p className='order__user__add'>User`s additional info: {user.additional_information}</p>
					</div>
			...
			<div>
				...
				<button className='button__type--btn button__type--indent' onClick={handleSubmitStatus} type='submit'>
